...
public class ScoreServiceJDBC implements ScoreService {
    ...
    public static final String CREATE_STATEMENT = "CREATE TABLE IF NOT EXISTS Score(player VARCHAR(32) NOT NULL, game VARCHAR(32) NOT NULL, points INT NOT NULL, playedOn TIMESTAMP NOT NULL);";
